...
- "output_format_description": A clear textual description of the expected output format. **Crucially, this output format MUST be verifiable using one of the following simple judging methods: {allowed_judge_types_string}. For example, specify if the output is a single integer, a list of numbers where order matters, a list of numbers where order does NOT matter, or a floating-point number requiring approximate comparison.**
...
{{
  ...
  "output_format_description": "Output is a list of strings representing the node names in the shortest path. Order matters.",
