...
## ❗️주의사항❗️
현재 2025.06.24 일 부로 Alpaco의 AI Service는 google ai studio에서 제공하는 무료 api로 젼환된 상태입니다.
모든 프롬프트는 구글의 모델 학습에 이용될 수 있으며, 10 RPM 500 req/day 의 rate limit이 적용되므로 서비스에 지연이 있을 수 있습니다.
이 점 인지하시면 감사하겠습니다.
---
