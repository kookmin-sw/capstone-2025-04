    ...
    <div className="max-w-6xl mx-auto p-6 sm:p-8">
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden p-6">
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-end gap-3">
          <Link
            href={`/submissions?problemTitle=${encodeURIComponent(problemTitleDisplay)}&userId=${submission?.userId}&author=${submission?.author ? encodeURIComponent(submission.author) : ''}`}
            className="px-4 py-2 border border-gray-300 text-sm font-medium rounded-md bg-white text-gray-700 hover:bg-gray-50 transition text-center flex items-center justify-center gap-1"
          >
