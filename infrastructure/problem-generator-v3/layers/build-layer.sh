#!/bin/bash
# capstone-2025-04/infrastructure/problem-generator-v3/layers/build-layer.sh
set -e

SCRIPT_DIR=$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)
# Updated to point to v3 lambda directory
LAMBDA_DIR="$SCRIPT_DIR/../../../backend/lambdas/problem-generator-v3"
